...
<html lang="en">
  <head>
    ...
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/assets/css/jquery.fancybox.css" type="text/css" media="screen" /> 
    <!-- Theme color -->
    <link id="switcher" href="<?php bloginfo('template_directory');?>/assets/css/theme-color/default-theme.css" rel="stylesheet">          

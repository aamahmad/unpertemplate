...
if ( ! function_exists( 'mj_wp_breadcrumb' ) ) {
        function mj_wp_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb', $active_class = 'active', $echo = false ) {
            ...
            if ( 'page' == get_option( 'show_on_front' ) && get_option( 'page_for_posts' ) ) {
                ...
                if ( is_home() ) {
                    $breadcrumb .= '<li class="' . $active_class . '"><em>' . get_the_title( $blog_page_id )  . '</em></li>';
            ...
            if ( is_singular( 'post' ) ) {
                ...
                // Post title
                $breadcrumb .= '<li class="' . $active_class . '"><em>' . get_the_title() . '</em></li>';
            }
            // Pages
            ...
            // Search
            if ( is_search() ) {
                $breadcrumb .= '<li class="' . $active_class . '"><em>' . __( 'Pencarian', $text_domain ) . '</em></li>';
            }
            // 404
            if ( is_404() ) {
                $breadcrumb .= '<li class="' . $active_class . '"><em>' . __( '404', $text_domain ) . '</em></li>';
            }
            // Custom Post Type Archive
      if ( is_post_type_archive() ) {
        $breadcrumb .= '<li class="' . $active_class . '"><em>' . post_type_archive_title( '', false ) . '</em></li>';
      }
      // Custom Taxonomies
      if ( is_tax() ) {
        ...
        // Term title
        $breadcrumb .= '<li class="' . $active_class . '"><em>' . single_term_title( '', false ) . '</em></li>';
      }
      // Custom Post Types
